...
<% if(board.getBoardReplyLev() == 0){ // 원글 수정%>
	<form action="/first/boriginup" method="POST" enctype="multipart/form-data">
		...
		<table align="center">
			<tr>
				<th>제목</th>
				<td><input name="btitle" value="<%= board.getBoardTitle()%>"></td>
			</tr>
			<tr>
				<th>작성자</th>
				<td><input name="bwriter" value="<%= board.getBoardWriter() %>" readonly></td>
			</tr>
			<tr>
				<th>첨부파일</th>
				<td>
			...
			<tr>
				<th>내용</th>
				<td><textarea rows="7" cols="50" name="bcontent"><%= board.getBoardContent() %></textarea></td>
			</tr>
			<tr>
				<th colspan="2">
