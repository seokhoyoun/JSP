...
function moveUpdatePage(){
	location.href = "/testmb/nupview?no=${notice.noticeNo}";
}

function deleteNotice(){
	location.href = "/testmb/ndel?no=${notice.noticeNo}";
}
</script>
</head>
<body>
...
<tr>
	<th>첨부파일</th>
	<td>
	<c:url var="nfdn" value="/testmb/nfdown">
...
<tr>
	...
	<button onclick="location.href='/testmb/nlist'; return false;">목록</button>
	</th>	
</tr>
</table>
<hr>
