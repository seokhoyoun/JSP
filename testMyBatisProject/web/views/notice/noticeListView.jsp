...
function moveWritePage(){
	...
	location.href="/testmb/views/notice/noticeWriteForm.jsp";
}
...
<div id="titleDiv">
	<form action="/testmb/nsearch" method="post">
...
<tr>
	...
	<td>
	<c:if test="${!empty loginUser }">
		<a href="/testmb/ndetail?no=${entry.key }">${entry.value.noticeTitle }</a>
	</c:if>
	<c:if test="${empty loginUser }">
