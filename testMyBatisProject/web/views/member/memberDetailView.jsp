...
</c:if><c:if test="${empty loginUser or loginUser.userId ne 'admin'}">
...
<table width="650" align="center">
	<tr height="40">
		...
		value="${requestScope.member.userId }"> 
		</td>
	</tr>
	<tr height="40">
		<th width="150">이 름</th>
	...
	<tr height="40">
		...
		name="userpwd" value="${requestScope.member.userPwd }"></td>
	</tr>
	<tr height="40">
	...
	<tr height="40">
		<th width="150">취 미</th>
		<td>
		<c:forTokens items="${requestScope.member.hobby }" delims="," var="s">
			<c:if test="${s eq 'game' }">
