			...
			success: function(data){
				...
				for(var i in json.list){
					<c:if test="${ !empty loginUser }">
						...
						+ "</td><td><a href='/testmb/bdetail?bnum=" 
			...
			success: function(data){
				...
				for(var i in json.list){
					<c:if test="${!empty loginUser }">
						...
						+ "</td><td><a href='/testmb/ndetail?no="
						+ json.list[i].no + "'>"
...
<form action="/testmb/login" method="post">
<table>
<tr>
<th>아이디 : </th>
...
<tr>
	<th colspan="2">
		...
		&nbsp; &nbsp; 
		<a href="/testmb/views/member/enroll.html">회원가입</a>
	</th>
</tr>
<tr>
	<th colspan="2">
...
<c:if test="${!empty loginUser }">
	...
	<td><a href="/testmb/logout">로그아웃</a> </td>
	</tr>
	<tr>
		<th colspan="2">
			<a href="">쪽지</a>
			&nbsp; &nbsp;
			<a href="/testmb/myinfo?userid=${loginUser.userId }">내 정보 보기</a>
		</th>
	</tr>
	</table>
	</div>
